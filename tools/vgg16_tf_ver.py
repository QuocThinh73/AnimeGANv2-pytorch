...
class VGG16:
    ...
    def build(self, rgb, include_fc=False):
        ...
        rgb_scaled = ((rgb + 1.0) / 2.0) * 255.0 # [-1, 1] -> [0, 1] -> [0, 255]
        ...
        self.conv4_3_no_activation = self.no_activation_convolution_layer(self.conv4_2, "conv4_3")
    ...
    def no_activation_convolution_layer(self, bottom, name):
        with tf.compat.v1.variable_scope(name):
            ...
            convolution = tf.nn.conv2d(bottom, filter, [1, 1, 1, 1], padding="SAME")
